...
namespace EnterpriseSolution.Core.Shared
{
    public static class Constants
    {
        ...
        public static class JournalPaymentType
        {
            ...
            public static string LoanInstallmentEntryDebit = "LIELIDP";
            public static string LoanInstallmentEntryCredit = "LIELICP";
        ...
        public static class UserNamingScheme
        {
            public static string MakerName(string firstName, string lastName)
            {
            ...
            public static string UserName(Users checker)
            {
                return (checker != null) ? checker.FirstName + " " + checker.LastName : "";
            }
        }
        ...
        public static class ScreenFieldsMapKeys
        {
            ...
            public const String AdjustmentTotalFCvalue = "AdjustmentTotalFCvalue";

            public const String ForeignCurrencyGain = "ForeignCurrencyGain";
            public const String ForeignCurrencyLoss = "ForeignCurrencyLoss";
            public const String GainOnSupplierPayment = "GainOnSupplierPayment";
            public const String LossOnSupplierPayment = "LossOnSupplierPayment";
            public const String GainOnExcessSupply = "GainOnExcessSupply";
            public const String LossOnShortSupply = "LossOnShortSupply";
        ...
        /// <summary>
        /// Give a month First and Last date
        /// </summary>
        /// <param name="month">Month Number</param>
        /// <returns>DateRangeDataModel</returns>
        //public static DateRangeDataModel OfMonth(int month)
        //{
