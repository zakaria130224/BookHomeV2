            ...
            function ($timeout,
                ...
                return {
                    ...
                    scope: {
                        ...
                        treeControl: '=',
                        expandTo: '=',
                        expandLevel: '=', //Submitted by: Abbir. Date: 07/10/2018.
                        searchBy: '='
                    },
                    link: function (scope, element, attrs) {
                        ...
                        //Submitted by: Abbir. Date: 07/10/2018.
                        //attrs.expandLevel = attrs.expandLevel ? attrs.expandLevel : '0';
                        //expand_level = parseInt(attrs.expandLevel, 10);

                        //Submitted by: Abbir. Date: 07/10/2018.
                        scope.expandLevel = scope.expandLevel ? scope.expandLevel : '0';
                        expand_level = parseInt(scope.expandLevel, 10);
                        ...
                        scope.$watch('expandLevel', function () {
                            scope.expandLevel = scope.expandLevel ? scope.expandLevel : '0';
                            expand_level = parseInt(scope.expandLevel, 10);
                        ...
                        //Submitted by: Abbir. Date: 08/10/2018.
                        on_searchBy_Change = function () {
                            if (angular.isDefined((scope.searchBy))) {
                                scope.customFilter = (typeof scope.searchBy === 'string') ? scope.searchBy.toLowerCase() : scope.searchBy.toString().toLowerCase();
                                console.log('filter: ' + scope.customFilter);
                                for_each_branch(function (b) {
                                    b.expanded = false;
                                    var glName = (typeof b.GLName === 'string') ? b.GLName.toLowerCase() : b.GLName.toString().toLowerCase();
                                    var glCode = (typeof b.GLCode === 'string') ? b.GLCode.toLowerCase() : b.GLCode.toString().toLowerCase();
                                    if ((glName.includes(scope.customFilter)) || (glCode.includes(scope.customFilter))) {
                                        return $timeout(function () {
                                            return select_branch(b);
                                        });
                                    }
                        ...
                        //Submitted by: Abbir. Date: 08/10/2018.
                        scope.$watch('searchBy', on_searchBy_Change, true);
                        ...
                        if (scope.treeControl != null) {
                            if (angular.isObject(scope.treeControl)) {
                                ...
                                tree.collapse_all = function () {
                                    scope.expandLevel = 0; //Submitted by: Abbir. Date: 08/10/2018.
